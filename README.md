# hasprr31web
hasprr31web is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install hasprr31web
```
## Usage

const Web3Tools = require('hasprr31web');
